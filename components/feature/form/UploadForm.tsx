...
export const UploadForm = () => {
    ...
    return (
        <form 
            className="space-y-4 px-2 lg:px-10 py-10 border border-cyan-300 rounded-lg max-w-3xl"
            onSubmit={(e) => {
                e.preventDefault()
                form.handleSubmit()
            }}
        >
            ...
            <form.Field
                ...
                {({ state, handleBlur, handleChange }) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.2 + 1 * 0.1, duration: 0.4 }}
                    >
                        ...
                        <input 
                            ...
                            className="w-full rounded-md border border-gray-700 bg-transparent py-2 px-3 text-white placeholder-gray-500 focus:border-cyan-500 focus:outline-none transition"
            ...
            <form.Field 
                ...
                {({ state, handleBlur, handleChange }) => (
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: 0.2 + 2 * 0.1, duration: 0.4 }}
                    >
